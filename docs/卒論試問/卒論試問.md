...
<div style="display: flex; align-items: flex-start; margin-top: -2.0em; gap: 0;">
<div style="flex: 1;">

PGD 攻撃は，
<div style="text-align: center; margin-top: -0.8em">

<b>摂動の $\ell_\infty$ ノルムが 上限 $\varepsilon$ 以下</b>

</div>
<div style="margin: 0.2em 0">という制約の下で<b>損失が大きくなる方向</b>への摂動の更新を反復</div>
<b>ランダムな初期点</b>から開始（<b>ランダム初期化</b>）

</div>
	<div style="flex: 0 0 258px; display: flex; align-items: flex-start; gap: 2px; margin-top: -0.5em; margin-right: -25px;">
		<div style="font-size: 13px; white-space: nowrap;">[3]</div>
		<img src="pgd.png" style="width: 270px;">
	</div>
</div>

> \[1]: Madry et al., "Towards Deep Learning Models Resistant to Adversarial Attacks," ICLR, 2018.
> \[3]: 稲岡 陽向，研究室内スライド「L1 正則化ニューラルネットワークの特徴量混合による敵対的堅牢性」（2025 年 5 月 27 日）をもとに作成
...
- **PGD 攻撃**：制約内で**損失を大きくする方向**への摂動の反復更新
...
![](cifar10_misclassification_heatmap.png)
